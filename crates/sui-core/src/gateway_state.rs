...
impl<A> GatewayState<A> {
    ...
    pub fn new(
        ...
        let epoch_store = Arc::new(EpochStore::new(base_path.join("epochs"), &committee));
        Self::new_with_authorities(
            gateway_store,
            AuthorityAggregator::new(committee, epoch_store, authority_clients, auth_agg_metrics),
            gateway_metrics,
        )
    }
